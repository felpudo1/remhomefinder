      ...
      <div className="bg-gradient-to-r from-primary/10 via-primary/5 to-transparent border border-primary/20 rounded-2xl p-6 space-y-4">
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          ...
          <Button
            variant="default"
            size="sm"
            className="rounded-xl gap-2 h-28 sm:h-10 bg-[#25D366] hover:bg-[#20ba5a] text-white border-none shadow-sm transition-all hover:scale-[1.02] flex-1 sm:flex-none text-base sm:text-sm"
